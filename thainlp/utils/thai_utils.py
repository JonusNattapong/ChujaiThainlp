...
def get_thai_stopwords() -> Set[str]:
    ...
    stopwords = {
        ...
        'เป็น', 'เนื่องจาก', 'เดียวกัน', 'เด็กๆ', 'เช่น', 'เฉพาะ', 
        'เคย', 'เข้า', 'เขา', 'อีก', 'อาจ', 'อะไร', 'ออก', 'อย่าง', 
        'อยู่', 'อยาก', 'หาก', 'หลาย', 'หลังจาก', 'หลัง', 'หรือ', 
        'หนึ่ง', 'ส่วน', 'ส่ง', 'สุด', 'สําหรับ', 'ว่า', 'วัน', 'ลง', 
        'ร่วม', 'ราย', 'รับ', 'ระหว่าง', 'รวม', 'ยัง', 'มี', 'มาก', 
        'มา', 'พร้อม', 'พบ', 'ผ่าน', 'ผล', 'บาง', 'น่า', 'นี้', 'นํา', 
        'นั้น', 'นัก', 'นอกจาก', 'ทุก', 'ที่สุด', 'ที่', 'ทําให้', 'ทํา', 
        'ทาง', 'ทั้งนี้', 'ทั้ง', 'ถ้า', 'ถูก', 'ถึง', 'ต้อง', 'ต่างๆ', 
        'ต่าง', 'ตาม', 'ตั้งแต่', 'ตั้ง', 'ด้าน', 'ด้วย', 'ดัง', 'ซึ่ง', 
        'ช่วง', 'จึง', 'จาก', 'จัด', 'งาน', 'จะ', 'คือ', 'ความ', 'ครั้ง', 
        'คง', 'ขึ้น', 'ของ', 'ขอ', 'ขณะ', 'ก่อน', 'ก็', 'การ', 'กับ', 
        'กัน', 'กว่า', 'กล่าว', 'นี่', 'นะ', 'น้อย', 'เกี่ยวกับ', 'เกิน', 
        'เกิด', 'เกือบ', 'ใกล้', 'ใคร', 'ใช่', 'ใช้', 'ใด', 'ใดๆ', 'ใคร', 
        'ใหญ่', 'ใหม่', 'ได้รับ', 'ไหน', 'ไป', 'ไทย', 'ไร', 'ไม่ใช่', 
        'ไม่', 'ไว', 'ไว้', 'ไป', 'ได้', 'ให้', 'ใน'
    }
    return stopwords
